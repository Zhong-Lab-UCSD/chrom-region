...
describe('ChromRegion tests: creation, I/O, properties.', function () {
  ...
  it('Create new from a ChromRegion-like object.', function () {
    ...
    expect(newChrRegion.name).to.be.equal('testRegion')
    expect(newChrRegion).to.not.haveOwnProperty('bedString')
    expect(newChrRegion)
      .to.have.property('someAdditionalProperty', 42)
  })
...
describe('ChromRegion tests: operations.', function () {
  it('Overlaps.', function () {
    ...
    expect(chrRegion1.overlaps(chrRegion2)).to.be.equal(0)
    expect(chrRegion1.overlaps(chrRegion3)).to.be.equal(0)
    expect(chrRegion1.overlaps(chrRegion4)).to.be.equal(7891)
    expect(chrRegion1.overlaps(chrRegion4, true)).to.be.equal(7891)
    expect(chrRegion1.overlaps(chrRegion0)).to.be.equal(0)
    expect(chrRegion0.overlaps(chrRegion2)).to.be.equal(0)
    expect(chrRegion4.overlaps(chrRegion1)).to.be.equal(7891)
    expect(chrRegion1.overlaps(chrRegion5)).to.be.equal(7891)
    expect(chrRegion1.overlaps(chrRegion5, true)).to.be.equal(0)
    expect(chrRegion1.overlaps(chrRegion6)).to.be.equal(7891)
    expect(chrRegion1.overlaps(chrRegion6, true)).to.be.equal(7891)
  })
  ...
  it('Concat.', function () {
    ...
    expect(chrRegion1.concat(chrRegion2)).to.be.equal(chrRegion1)
    expect(chrRegion1.toString()).to.be.equal('chr1:12345-167890 (+)')
    chrRegion1 = new ChromRegion('chr1:12345-67890(+)')
    expect(chrRegion1.concat(chrRegion2, true)).to.be.equal(chrRegion1)
    expect(chrRegion1.toString()).to.be.equal('chr1:12345-167890 (+)')
    chrRegion1 = new ChromRegion('chr1:12345-67890(+)')
    expect(chrRegion2.concat(chrRegion1)).to.be.equal(chrRegion2)
    expect(chrRegion2.toString()).to.be.equal('chr1:12345-167890 (+)')
    expect(chrRegion1.concat(chrRegion3)).to.be.null()
    expect(chrRegion1.concat(chrRegion4)).to.be.null()
    expect(chrRegion1.concat(chrRegion5)).to.be.equal(chrRegion1)
    expect(chrRegion1.toString()).to.be.equal('chr1:12345-167890 (+)')
    chrRegion1 = new ChromRegion('chr1:12345-67890(+)')
    expect(chrRegion1.concat(chrRegion5, true)).to.be.null()
    expect(chrRegion1.concat(chrRegion6, true)).to.be.equal(chrRegion1)
    expect(chrRegion1.toString()).to.be.equal('chr1:12345-167890 (+)')
  })
